...
def get_favorite_vegetable():
    ...
    favorite_vegetable = str(input("Please enter your favorite vegetable"))
    print("Interesting! I also love ",favorite_vegetable,"!",sep="")
...
def get_favorite_number():
    ...
    print("Interesting! I also love ",favorite_number,"!",sep="")
...
def get_name_and_zodiac_sign():
    ...
    print("Interesting! My name is also ",name,", and I'm also a ",zodiac_sign,"!",sep="")
...
def get_name_and_age():
    ...
    """
    # write your code here.
    nameforage = input("Please enter your name")
    age = input("Please enter your age")
    print("Interesting! My name is also ",nameforage,", and I'm also ",age," years old!",sep="")
